...
class FullComponent(TreeComponent):
    ...
    def _dec_session_coverage(self, session_id: str, leaf: UnifiedTreeNode) -> None:
        ...
        while node is not None and node is not self.tree_core.root_node:
            ...
            self.tree_core.update_component_session_ref(node, self.component_type, -1)
            node = node.parent
    ...
    def acquire_component_lock(
        ...
        while cur is not root:
            ...
            if cd.lock_ref == 0:
                ...
                self.tree_core._update_component_evictable_size(cur, ct, -key_len)
        ...
        *,
        ...
        if phase == CacheTransferPhase.BACKUP_HOST:
            ...
            for nid in xfer.nodes_to_load or []:
                ...
                self.tree_core._update_component_evictable_size(n, ct, n_len)
